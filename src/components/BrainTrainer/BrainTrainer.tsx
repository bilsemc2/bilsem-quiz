...
import "./BrainTrainer.css"; // Kullanılabilir beyin antrenörleri listesi
const brainActivities = [
  {
    id: "color-grid",
    title: "Renk Sekansı",
    description:
      "Işıklı renk sekanslarını doğru sırada tekrar edin. Hafıza ve dikkat becerinizi geliştirir.",
  ...
  },
  {
    ...
    title: "Renk Algılama",
    description:
      "Kısa süreliğine görünen renkleri hızlıca algılayın ve doğru belirleyin. Algı ve tepki hızınızı artırır.",
  ...
  },
  {
    ...
    title: "Kozmik Hafıza",
    description:
      "Parlayan yıldız sekanslarını hatırla. Uzamsal hafızanı ve çalışma belleğini zorla.",
  ...
  return (
    <div className="brain-trainer-container">
      ...
      <div className="brain-trainer-header">
        ...
        <p>
          Beyin gücünüzü geliştiren çeşitli egzersizlerle zihinsel
          becerilerinizi test edin ve geliştirin!
        </p>{" "}
      </div>{" "}
      ...
      <div className="brain-trainer-info">
        ...
        <p>
          {" "}
          Beyin Antrenörü, zihinsel becerilerinizi geliştirmenize yardımcı olan
          interaktif egzersizler sunarak beyin işlevlerinizi güçlendirmenizi
          sağlar. Düzenli kullanımla hafıza, dikkat, problem çözme ve tepki
          süresi gibi bilişsel becerilerde gelişme sağlayabilirsiniz.{" "}
        </p>{" "}
