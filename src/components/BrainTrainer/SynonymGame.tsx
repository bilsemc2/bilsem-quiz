                ...
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    {(phase !== 'game_over' && phase !== 'victory' && phase !== 'finished') && (
                        <div className="flex items-center gap-4 flex-wrap">
                            ...
                            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-500/20 border border-emerald-500/30"><BookOpen className="text-emerald-400" size={18} /><span className="font-bold text-emerald-400">{currentIndex + 1}/{questions.length}</span></div>
                        </div>
                    )}
                </div>
            </div>
