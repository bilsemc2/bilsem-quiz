...
import { Trophy, RotateCcw, Play, Star, Target, CheckCircle2, XCircle, ChevronLeft, Zap, BookText, Loader2, AlertCircle, Lightbulb } from 'lucide-react';
            ...
            <div className="container mx-auto max-w-4xl">
                ...
                >
                    ...
                    <h1 className="text-4xl lg:text-5xl font-black text-white mb-2">
                        📖 <span className="text-emerald-400">Eş</span> Anlam
                    </h1>
                    <p className="text-slate-400">Kelimenin eş anlamlısını bul!</p>
                </motion.div>
                    ...
                    {gameState === 'idle' && (
                        ...
                        >
                            <div className="bg-slate-800/50 border border-white/10 rounded-3xl p-8 max-w-md">
                                ...
                                <h2 className="text-2xl font-bold text-white mb-4">Eş Anlam Testi</h2>
                                ...
                                <div className="bg-slate-700/50 rounded-xl p-4 mb-6">
                                    ...
                                    <p className="text-slate-400 text-sm">
                                        Cevap: <span className="text-amber-400 font-bold">mutlu</span>
                                    </p>
                                    <p className="text-slate-500 text-xs mt-2">
                                        (Mesut = Mutlu, aynı anlama gelen kelimeler)
                                    </p>
                                </div>
                                ...
                                <ul className="text-slate-400 text-sm space-y-2 text-left mb-6">
                                    <li className="flex items-center gap-2">
                                        ...
                                        Verilen kelimenin <strong className="text-white">eş anlamlısını</strong> bul
                                    </li>
                                    <li className="flex items-center gap-2">
                                    ...
                                    <li className="flex items-center gap-2">
                                        ...
                                        {totalQuestions} soru, kelime hazneni test et!
                                    </li>
                                </ul>
                    ...
                    {gameState === 'playing' && currentQuestion && (
                        ...
                        >
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    <p className="text-slate-400 text-sm text-center mb-4">Aşağıdaki kelimenin eş anlamlısını bulun:</p>
                                    <h2 className="text-4xl lg:text-5xl font-black text-emerald-400 text-center">
                            ...
                            <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 rounded-3xl p-8">
                                ...
                                <div className="grid grid-cols-2 gap-4 my-6">
                                    ...
                                    <div className="bg-slate-800/50 rounded-xl p-4">
                                        ...
                                        <p className="text-2xl font-black text-teal-400">{correctCount}/{questions.length}</p>
                                    </div>
                                    <div className="bg-slate-800/50 rounded-xl p-4">
