    ...
    >
      <defs>
        ...
        >
          <stop
            offset="0%"
            stopColor={shape.fillLeft || shape.fill || CANDY_COLORS[0]}
          />
          <stop
            offset="100%"
            stopColor={shape.fillRight || shape.fill || CANDY_COLORS[0]}
          />
        </linearGradient>
          ...
          <>
            ...
            <g clipPath={`url(#clip-right-${shape.id})`}>
              {renderShape(
                ...
                center,
                shapeSize,
                shape.fillRight || CANDY_COLORS[1],
                shape.id,
                shape.strokeWidth,
                shape.strokeColor,
              )}
        ...
        {shape.coloredBars && (
          <g>
            {shape.coloredBars.colors.map((color, index) => {
              ...
              const offsetIndex =
                (index + shape.coloredBars!.offset) % barCount;
...
const InnerGridRenderer: React.FC<InnerGridRendererProps> = ({
  grid,
  size,
  cellColor,
}) => {
  ...
  return (
    <div
      ...
      style={{
        ...
        height: size,
        background:
          "linear-gradient(135deg, rgba(30, 30, 50, 0.9) 0%, rgba(20, 20, 40, 0.9) 100%)",
        boxShadow:
          "inset 0 -4px 8px rgba(0,0,0,0.3), inset 0 4px 8px rgba(255,255,255,0.1)",
        display: "grid",
