  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row lg:items-start lg:gap-8">
        {/* Kartlar */}
        <div className="flex flex-wrap justify-center mb-6 lg:mb-0 gap-3 sm:gap-4 min-h-[140px] lg:flex-1">
        ...
        {question ? (
          <motion.div
            ...
            className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-800 border-2 border-black/10 shadow-neo-sm w-full lg:w-[380px] lg:flex-shrink-0"
          >
