                ...
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    {(phase !== 'game_over' && phase !== 'victory') && (
                        <div className="flex items-center gap-4 flex-wrap">
                            ...
                            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-500/20 border border-purple-500/30"><Zap className="text-fuchsia-400" size={18} /><span className="font-bold text-fuchsia-400">Seviye {level}</span></div>
                        </div>
                    )}
                </div>
            </div>
