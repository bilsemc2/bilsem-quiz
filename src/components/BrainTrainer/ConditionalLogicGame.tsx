                ...
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    {(phase === 'playing' || phase === 'feedback') && (
                        <div className="flex items-center gap-4 flex-wrap">
                            ...
                            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-500/20 border border-indigo-500/30"><Zap className="text-indigo-400" size={18} /><span className="font-bold text-indigo-400">{level}/{MAX_LEVEL}</span></div>
                        </div>
                    )}
                </div>
            </div>
