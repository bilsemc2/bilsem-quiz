...
export const contentRoutes = [
    ...
    // Protected Content
    <Route key="deyimler" path="/deyimler" element={protectElement(<DeyimlerPage />)} />,
    <Route key="pdf" path="/create-pdf" element={protectElement(<CreatePdfPage />)} />,
    <Route key="profile" path="/profile" element={protectElement(<ProfilePage />, { skipXPCheck: true })} />,
    <Route key="homework" path="/homework" element={protectElement(<HomeworkPage />)} />,
    <Route key="quizizz" path="/quizizz-kodlari" element={protectElement(<QuizizzCodesPage />)} />,
    // Story Routes
    <Route key="stories" path="/stories" element={protectElement(<StoryListPage />)} />,
    <Route key="story" path="/stories/:id" element={protectElement(<StoryDetailPage />)} />,
    <Route key="quiz" path="/stories/quiz-game" element={protectElement(<StoryQuizGame />)} />,
];
