                        ...
                        <Grid item xs={6} key={option}>
                          <Box 
                            ...
                            sx={{ 
                              ...
                              p: 1.5,
                              borderRadius: 2,
                              border: option === getCorrectLetter(parseInt(previewQuestion)) ? '2px solid #4caf50' : '1px solid rgba(0, 0, 0, 0.08)',
                              bgcolor: option === getCorrectLetter(parseInt(previewQuestion)) ? 'rgba(76, 175, 80, 0.08)' : 'transparent',
                              width: '100%',
                          ...
                          >
                            <Typography
                              sx={{
                                ...
                                justifyContent: 'center',
                                flexShrink: 0,
                                bgcolor: option === getCorrectLetter(parseInt(previewQuestion)) ? 'success.main' : 'grey.200',
                                color: option === getCorrectLetter(parseInt(previewQuestion)) ? 'white' : 'text.secondary',
                                fontSize: '0.875rem',
                                fontWeight: 600
                              }}
                            >
                            ...
                            <Box sx={{ 
                              ...
                              <LazyLoadImage
                                src={`images/options/Matris/${previewQuestion}/Soru-${previewQuestion}${option}.webp`} 
                                alt={`Seçenek ${option}`}
                                effect="blur"
                                width={30}
                                height={30}
                              ...
                              />
                              <LazyLoadImage
                                src={`images/options/Matris/${previewQuestion}/Soru-cevap-${previewQuestion}${option}.webp`} 
                            ...
                            {option === getCorrectLetter(parseInt(previewQuestion)) && (
                              <Chip
                                label="Doğru Cevap"
                                size="small"
                                color="success"
