        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
                <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    ...
                    <span className="block text-indigo-600">İletişime Geçin</span>
                </h1>
                        ...
                        <div className="p-8">
                            ...
                            <div className="mt-8 text-center">
                                ...
                                <p className="mt-2 text-sm text-gray-500">
                                    Mesai saatleri: Her gün 09:00 - 21:00
                                </p>
                            </div>
                            <div className="mt-8">
                                <a
                                    ...
                                    className="block w-full bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-6 rounded-lg text-center transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
                                >
