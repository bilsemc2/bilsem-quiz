        ...
        <div className="max-w-md w-full space-y-8 text-center">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-700 bg-yellow-50 p-3 rounded-lg">
              ...
              PDF Oluştur özelliği ile matris tipi soruları içeren sınavlar hazırlayabilirsiniz. İstediğiniz sayıda soruyu sıralı veya rastgele seçebilir, otomatik olarak profesyonel görünümlü PDF'ler oluşturabilirsiniz. Oluşturulan PDF'ler cevap anahtarı da içerir ve yazdırmaya hazırdır.
              <br /><br />
