    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (authData.user) {
                ...
                // Referral kullanıldıysa ekstra mesaj göster
                const successMessage = formData.referralCode
                    ? 'Kayıt başarılı! Arkadaşınız 50 XP kazandı. Lütfen email adresinizi onaylayın ve giriş yapın.'
                    : 'Kayıt başarılı! Lütfen email adresinizi onaylayın ve giriş yapın.';
