...
export const OYUN_ZEKA_ESLESTIRMESI: Record<string, ZekaTuru> = {
    ...
    'deyimler-oyunu': ZEKA_TURLERI.SOZEL_ZEKA,
    'stroop': ZEKA_TURLERI.BILISSEL_ESNEKLIK,
    ...
    'isitsel-bellek': ZEKA_TURLERI.CALISMA_BELLEGI,
    'sayisal-hafiza': ZEKA_TURLERI.CALISMA_BELLEGI,
    'renk-algilama': ZEKA_TURLERI.GORSEL_ALGI,
    'renk-sekans': ZEKA_TURLERI.GORSEL_HAFIZA,
...
export const OYUN_WORKSHOP_ESLESTIRMESI: Record<string, WorkshopType> = {
    ...
    'isitsel-bellek': 'bireysel',
    'sayisal-hafiza': 'bireysel',
    'renk-algilama': 'bireysel',
    'renk-sekans': 'bireysel',
    ...
    'pattern-pop': 'bireysel',
    'algisal-hiz': 'bireysel',
