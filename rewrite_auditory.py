                ...
                <div className="flex gap-3 items-center flex-wrap justify-center max-w-sm mt-4">
                  {sequence.map((noteIdx, i) => (
                    <motion.div
                      ...
                      className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-syne font-black border-4 transition-all duration-300 ${
                        i === currentPlayIndex
...
with open("/Users/yetenekvezeka/bilsemc2/bilsem-quiz/src/components/BrainTrainer/AuditoryMemoryGame.tsx", "w") as f:
    f.write(content)
