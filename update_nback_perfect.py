...
# 2. Slice out the old JSX block
start_idx = content.find("if (phase === 'welcome') {")
if start_idx == -1:
...
print("Updated NBackGame successfully via string slicing with explicit export default!")
